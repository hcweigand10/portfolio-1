             ...
             <section className="row my-1 mx-auto p-3">
                ...
                <div className="col-md-7 p-3">
                    <div className="pt-3 h-100">
                        ...
                        <p>
                            I currently at work the UC Berkeley's Full Stack Coding Boot Camp and freelance as a website builder. If you need a new online presence, please reach out!
                        </p>
                        <p>
